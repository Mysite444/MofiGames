...
export interface Game {
  ...
  /**
   * Three purpose-specific covers added in migration 0068 to prevent
   * object-fit cropping of important artwork on different card layouts.
   *
   * landscapeCoverUrl  → 16:9 (1280×720) — large homepage cards, genre
   *                       rows, Featured, Trending, Popular, Today's Best.
   * squareCoverUrl     →  1:1 (800×800)  — Continue Playing, Favorites,
   *                       Saved Games, compact square card grids.
   * portraitCoverUrl   →  2:3 (800×1200) — portrait grids, mobile portrait
   *                       cards, MofiGames Originals-style tall tiles.
   *
   * All three are optional — existing games without them fall back to
   * thumbnailUrl → coverImageUrl → placeholder (see lib/game-cover.ts).
   */
